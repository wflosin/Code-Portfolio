...
class Popup(pg.sprite.Sprite):
    ...
    def __init__(self,pos,rect):
        ...
        input_box_title = InputBox(30+self.rect.x, 60+self.rect.y, 140, 20)
        input_box_section = InputBox(30+self.rect.x, 150+self.rect.y, 140, 20)
        input_box_due = InputBox(30+self.rect.x, 240+self.rect.y, 140, 20, '2019-')
        input_box_start = InputBox(30+self.rect.x, 330+self.rect.y, 140, 20)
        input_box_notes = InputBox(30+self.rect.x, 420+self.rect.y, 140, 20)
    ...
    def update(self, surface):        
        ...
        title_text = title_font.render("Add Assignment", True, BLACK)
